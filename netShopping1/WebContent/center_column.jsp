...
<div class="divBorder">
	...
	<div id="select_product">
		<div id="select_img"><a href="showProByIDAction.action?id=1"><img width="205" height="154" src="Picture/1.jpg"></a></div>
			<div id="select_about"><a class="a" href="showProByIDAction.action?id=1">品名：油漆边双色龙骨扇_粉色 </a><br>
			促销价：<span style="color:#FF6600;font-weight:bold;">￥18</span>元<br>
			已售出：<span style="font-weight:bold;">86</span>&nbsp;笔
		</div>		
	</div>	
	<div id="select_product">
		<div id="select_img"><a href="showProByIDAction.action?id=2"><img width="205" height="154" src="Picture/2.jpg"></a></div>
			<div id="select_about"><a class="a" href="showProByIDAction.action?id=2">品名：油漆边双色龙骨扇_红色  </a><br>
			促销价：<span style="color:#FF6600;font-weight:bold;">￥18</span>元<br>
			已售出：<span style="font-weight:bold;">5</span>&nbsp;笔
		</div>		
	</div>
	<div id="select_product">
		<div id="select_img"><a href="showProByIDAction.action?id=3"><img width="205" height="154" src="Picture/3.jpg"></a></div>
			<div id="select_about"><a class="a" href="showProByIDAction.action?id=3">品名：油漆边双色龙骨扇_蓝色          </a><br>
			促销价：<span style="color:#FF6600;font-weight:bold;">￥17</span>元<br>
			已售出：<span style="font-weight:bold;">9</span>&nbsp;笔
		</div>		
	</div>
	<div id="select_product">
		<div id="select_img"><a href="showProByIDAction.action?id=4"><img width="205" height="154" src="Picture/4.jpg"></a></div>
			<div id="select_about"><a class="a" href="showProByIDAction.action?id=4">品名：油漆边双色龙骨扇_紫色  </a><br>
