...
var phxWin=window.open(url,'','width='+width+',height='+height+',left='+(screen.width-width)/2+',top='+(screen.height-height)/2+'');
	...
	<div id="header_right">
		...
		<br>
		<img src="images/chat.png" />&nbsp;<a onClick="openWin('contact.jsp',300,200)" style="cursor:hand" >联系我们</a> <img src="images/order.png" />&nbsp;<a href="showCartByUserNameAction.action">购物车</a>
	</div>
	...
	<div id="headermenu">
		...
		<li>
			<a class="li" href="showAllProAction.action" ><img src="images/dh_3.png" border= "0 "/>&nbsp全部商品</a>
		</li>
